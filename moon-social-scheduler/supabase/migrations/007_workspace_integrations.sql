...
CREATE TABLE IF NOT EXISTS "PlatformAppCredential" (
    "id" TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS "WorkspaceAiSettings" (
    "id" TEXT NOT NULL,
    "workspaceId" TEXT NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS "PlatformAppCredential_workspaceId_platform_key" ON "PlatformAppCredential"("workspaceId", "platform");
CREATE INDEX IF NOT EXISTS "PlatformAppCredential_workspaceId_platform_idx" ON "PlatformAppCredential"("workspaceId", "platform");

CREATE UNIQUE INDEX IF NOT EXISTS "WorkspaceAiSettings_workspaceId_key" ON "WorkspaceAiSettings"("workspaceId");
